/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 612006a2daf649eb360fd365d554fed4)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PUBLIC_WORDPRESS_API: string;
	CONTACT_EMAIL: string;
	WP_CONTACT_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_WORDPRESS_API" | "CONTACT_EMAIL" | "WP_CONTACT_SECRET">> {}
}
